...
def RK45(f, t0, tf, dtInitial, x0, y0, z0, epsilon):
    ...
    while t[i] < tf:
        ...
        l4 = K4[1]
        m4 = K4[2]
        K5 = multiply(dt,f(t[i]+dt, x[i]+439*k1/216 - 8*k2 + 3680*k3/513 - 845*k4/4104, y[i]+439*l1/216 - 8*l2 + 3680*l3/513 - 845*l4/4104, z[i]+439*m1/216 - 8*l2 + 3680*m3/513 - 845*m4/4104))
        k5 = K5[0]
        l5 = K5[1]
        m5 = K5[2]
...
# Plot our solution
plt.rcParams["figure.figsixe"] = (25,14)
plt.figure(1)
plt.plot(t,x)
plt.figure(2)
plt.plot(x,y)